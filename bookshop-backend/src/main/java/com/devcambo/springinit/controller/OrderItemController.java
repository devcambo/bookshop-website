...
public class OrderItemController {
  ...
  public ResponseEntity<APIResponse> findAllOrderItems(
          ...
          @Parameter(description = "Sort by field (orderItemId, orderId)", example = "orderItemId") @RequestParam(
                  value = "sortBy",
                  required = false,
  ...
  public ResponseEntity<APIResponse> deleteOrderItem(@PathVariable Long orderItemId) {
    ...
    return ResponseEntity
            ...
            .body(new APIResponse(true, StatusCode.NO_CONTENT, "Order item deleted successfully"));
  }
}