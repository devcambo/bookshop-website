...
public record BookUpdateDto(
        @Schema(description = "Book title", example = "The Great Gatsby Updated")
        String title,
        ...
        @Schema(description = "Book ISBN", example = "978-3-16-148410-0 Updated")
        String isbn,
        @Schema(description = "Book price", example = "19.99")
        BigDecimal price,
        @Schema(description = "Book description", example = "A classic novel about the American Dream. Updated")
        String description,
